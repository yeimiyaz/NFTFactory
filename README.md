This is an example of NFT Factory based on the functionality of OpenSeaCreatures (https://github.com/ProjectOpenSea/opensea-creatures).

Basically, it is possible to define a token considering a name and a symbol in the file Creature.sol. This solution was validate using INFURIA y the functionalities of the contract were tested using truffle. The contract was deployed on the rinkeby network and the token was registered on opensea. Finally, the token was listed on Opensea.
